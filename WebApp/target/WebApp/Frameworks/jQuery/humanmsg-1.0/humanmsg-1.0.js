...
var humanMsg = {
	setup: function(appendTo, logName, msgOpacity) {
		...
		jQuery(appendTo).append('<div id="'+humanMsg.msgID+'" class="reset-this humanMsg"><div class="round"></div><p></p><div class="round"></div></div> <div id="'+humanMsg.logID+'" class="reset-this"><p>'+logName+'</p><ul></ul></div>')
	...
	displayMsg: function(msg, noshow) {
		if (msg == '')
			return;
