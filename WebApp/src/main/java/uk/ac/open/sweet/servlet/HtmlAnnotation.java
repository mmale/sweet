...
public class HtmlAnnotation extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
        	...
        	//String message ="Your annotation was saved! Location:c:/Temp/HtmlAnnotation.html";
        	out.write(innerHtml.getBytes(), 0, innerHtml.getBytes().length);

           /* FileDialog fd = new FileDialog(new Frame(), "Save MicroWSMO HTML...",    FileDialog.SAVE);
            	fd.setFile("*.html");
            	fd.setDirectory(".\\");
        	...
        	//FileDialog d = new FileDialog(frame, "Save", FileDialog.SAVE); // have to specify the frame yourself
