...
CmdUtils.CreateCommand({
    ...
    homepage: "http://purl.oclc.org/NET/sweetserver",
    license: "Apache? TBD", //TODO
    description: "Displays sweet results for a term or a set of discovered terms in the input",
    help: "see http://purl.oclc.org/NET/sweetserver",

  preview: function(previewBlock, term) {
    previewBlock.innerHTML = "looking up " + term.text + " with sweet \u2026 ";
    displayMessage(term.text);
        previewBlock.innerHTML = "<iframe src='http://sweetdemo.kmi.open.ac.uk/UI/index.html' border='0' width='100%' height='100%' scrolling='yes' style='border: 0; margin: 0;' ></iframe>";
